    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <Card className="text-center">
        ...
        {loading ? (
          ...
          <ReputationLive rep={rep} address={handle} />
        ) : (
      ...
      {rep && (
        <Card>
          ...
          <div className="mt-3 bg-background border border-border rounded-md p-3 font-mono text-xs break-all">
            {`<a href="https://kanorails.vercel.app/p/${handle}"><img src="https://kanorails.vercel.app/badge/${handle}.svg" /></a>`}
          </div>
        </Card>
      )}
